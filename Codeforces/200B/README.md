...
### Thought Process
It is just an easy math problem. We need to divide the given quantities by 100 and then sum it up. After the total count divide again with the first input and multiply with 100. It would produce the result.